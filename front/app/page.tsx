...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-[#bc151b] selection:text-white overflow-x-hidden">
      {/* 1. Header/Navbar */}
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/5">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-[#bc151b] rounded-md flex items-center justify-center font-title font-bold text-white text-base shadow-[0_0_10px_rgba(188,21,27,0.5)]">
            PKA
          </div>
          <span className="font-title font-bold text-base tracking-wider uppercase hidden sm:inline-block">
            Panggung Kreator Akademi
          </span>
        </div>
        <div className="flex items-center gap-4">
          <Link href="/login" className="px-5 py-2 text-xs md:text-sm font-bold text-white uppercase tracking-wider bg-transparent border border-white/20 rounded-full hover:border-[#bc151b] transition-all">
            Login
          </Link>
          <Link href="/login" className="px-5 py-2 text-xs md:text-sm font-bold text-white uppercase tracking-wider bg-[#bc151b] rounded-full hover:bg-[#bc151b]/80 shadow-[0_0_15px_rgba(188,21,27,0.4)] transition-all">
            Daftar Sekarang
          </Link>
        </div>
      </header>
      ...
      <section className="relative pt-36 pb-24 px-6 md:px-12 flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto z-10 flex flex-col items-center">
          <span className="px-4 py-1.5 rounded-full bg-[#bc151b]/15 border border-[#bc151b]/30 text-[#bc151b] text-xs md:text-sm font-semibold tracking-wider uppercase mb-6 animate-pulse">
            Bukan Sekadar Belajar Ngomong.
          </span>
          
          <h1 className="text-4xl md:text-7xl font-title font-bold tracking-tight text-white uppercase leading-tight max-w-3xl mb-8">
            Tapi Belajar Gimana <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-red-200 to-[#bc151b] underline decoration-[#bc151b] decoration-4">
              Cara Lo Didengar.
            </span>
          </h1>

          <div className="text-zinc-400 text-sm md:text-base max-w-2xl space-y-4 mb-10 text-center leading-relaxed">
            <p>Banyak orang punya potensi. Punya cerita. Punya skill. Punya mimpi besar.</p>
            <p>Tapi sayangnya… <span className="text-white font-semibold">mereka gak pernah punya panggung.</span></p>
            ...
            <p className="text-zinc-300">Dan akhirnya? Potensi mereka cuma jadi <span className="italic">“niat”</span>.</p>
          </div>

          {/* Solution Highlight Box */}
          <div className="w-full max-w-xl bg-zinc-900/60 border border-white/5 rounded-2xl p-6 md:p-8 backdrop-blur-sm text-left mb-10 shadow-xl">
            <h3 className="font-title font-bold text-lg md:text-xl text-white mb-4 uppercase tracking-wider border-b border-white/10 pb-2">
              Panggung Kreator Akademi hadir buat bantu lo:
            </h3>
            <ul className="space-y-3.5 text-zinc-300 text-sm md:text-base">
              {[
          ...
          <p className="text-zinc-400 text-xs md:text-sm font-medium tracking-wide uppercase max-w-md border-t border-white/10 pt-6 mb-8">
            Karena hari ini… Kesempatan sering datang bukan ke yang paling pintar. <br />
            <span className="text-white font-bold">Tapi ke mereka yang berani tampil.</span>
          </p>

          <Link href="/login" className="px-10 py-5 text-lg font-bold text-white uppercase tracking-wider bg-[#bc151b] rounded-xl hover:bg-[#bc151b]/90 transition-all transform hover:scale-105 shadow-[0_0_30px_rgba(188,21,27,0.5)]">
            DAFTAR SEKARANG
          </Link>
        </div>
      </section>
      ...
      {/* 3. Welcome Section */}
      <section className="py-24 px-6 md:px-12 bg-zinc-950/80 border-y border-white/5 relative">
        ...
        <div className="max-w-4xl mx-auto z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-title font-bold uppercase tracking-wide mb-4">
          ...
          <div className="bg-zinc-900/40 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
            <p className="text-zinc-300 text-sm md:text-base mb-6 text-center italic">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm md:text-base">
              {[
                ...
                <div key={index} className="flex items-center gap-3 bg-[#0a0a0a]/50 p-4 rounded-xl border border-white/5">
            ...
            <p className="mt-8 text-center text-zinc-400 text-xs md:text-sm font-semibold uppercase tracking-wider border-t border-white/5 pt-6">
              Karena di dunia sekarang… orang yang bisa menyampaikan value dirinya dengan baik, <span className="text-white">akan punya peluang lebih besar.</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 bg-[#0a0a0a] relative">
        ...
        <div className="max-w-5xl mx-auto z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-title font-bold uppercase tracking-wider mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div key={index} className="bg-zinc-900/30 border border-white/5 p-6 rounded-2xl hover:border-[#bc151b]/40 hover:bg-[#bc151b]/5 transition-all group">
                ...
                <h3 className="font-title font-bold text-lg text-white mb-2 uppercase group-hover:text-[#bc151b] transition-all">
                  {item.title}
                </h3>
          ...
          <div className="text-center max-w-xl mx-auto bg-gradient-to-r from-zinc-950 via-[#bc151b]/10 to-zinc-950 border border-white/5 p-6 rounded-2xl shadow-lg">
            <p className="text-zinc-400 text-sm uppercase tracking-wider mb-2 font-medium">Padahal…</p>
            <h4 className="text-2xl md:text-3xl font-title font-bold text-white uppercase tracking-wider mb-1">
              Public Speaking Bukan Bakat.
            </h4>
            <p className="text-lg md:text-xl font-bold text-[#bc151b] uppercase">
              Public Speaking adalah Skill. <span className="text-white font-normal text-sm lowercase block mt-1 text-zinc-400">Dan skill bisa dilatih.</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 bg-zinc-950/90 border-t border-white/5 relative">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-[#bc151b] text-xs font-bold uppercase tracking-widest block mb-3">
              Kurikulum Utama PKA
            </span>
            <h2 className="text-3xl md:text-5xl font-title font-bold uppercase tracking-wider">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Card 1 */}
            <div className="bg-zinc-900/55 border border-white/5 rounded-3xl p-8 hover:border-[#bc151b]/35 transition-all">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="font-title font-bold text-xl md:text-2xl text-white uppercase">
                  Confident Speaking
                </h3>
              </div>
              ...
              <div className="border-t border-white/5 pt-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs md:text-sm text-zinc-400">
      ...
      <section className="py-24 px-6 md:px-12 bg-[#0a0a0a] relative">
        ...
        <div className="max-w-4xl mx-auto z-10">
          ...
          <div className="bg-zinc-900/30 border border-white/5 rounded-3xl p-8 backdrop-blur-sm shadow-xl">
            <h3 className="font-title font-bold text-lg md:text-xl text-white mb-6 uppercase tracking-wider text-center border-b border-white/10 pb-3">
              Panggung Kreator Akademi cocok buat lo yang:
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-zinc-300 text-sm md:text-base">
              {[
                ...
                <div key={index} className="flex items-start gap-3 bg-[#0a0a0a]/30 p-4 rounded-xl border border-white/5 hover:border-[#bc151b]/35 transition-all">
      ...
      <section className="py-24 px-6 md:px-12 bg-zinc-950 border-y border-white/5 relative">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-[#bc151b] text-xs font-bold uppercase tracking-wider mb-3 block">
            This Is More Than A Course
          </span>
          <h2 className="text-3xl md:text-6xl font-title font-bold uppercase tracking-tight text-white mb-6">
          ...
          <div className="text-zinc-400 text-sm md:text-base leading-relaxed space-y-4 max-w-2xl mx-auto mb-12">
            <p>Di Panggung Kreator Akademi, lo akan ketemu banyak orang yang juga sedang berproses.</p>
            <p>Karena kadang… <span className="text-white font-semibold">yang bikin kita berkembang bukan cuma materi. Tapi lingkungan.</span></p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={index} className="bg-zinc-900/35 border border-white/5 p-6 rounded-2xl flex flex-col items-center">
                ...
                <h4 className="font-title font-bold text-base uppercase text-white mb-2">{item.title}</h4>
      ...
      <section className="py-24 px-6 md:px-12 bg-[#0a0a0a] relative">
        ...
        <div className="max-w-4xl mx-auto z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-title font-bold uppercase tracking-wide mb-6">
          ...
          <div className="max-w-xl mx-auto text-left space-y-4 mb-12">
            {[
              ...
              <div key={index} className="flex items-center gap-4 bg-zinc-900/40 p-4 rounded-xl border border-white/5 hover:border-[#bc151b]/30 transition-all">
                <span className="text-[#bc151b] font-title font-bold text-sm">✓</span>
                <span className="text-zinc-200 text-sm md:text-base font-medium">{item}</span>
              </div>
            ))}
          </div>

          <div className="inline-block py-4 px-8 bg-zinc-950 border border-white/10 rounded-2xl mb-8">
            <p className="text-zinc-400 text-sm">
              Dan semua itu… dimulai dari satu keputusan kecil: <span className="text-white font-bold uppercase tracking-wide text-base ml-1">Berani mulai.</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 bg-zinc-950/90 border-t border-white/5 relative">
        ...
        <div className="max-w-6xl mx-auto z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Facilities column */}
            <div>
              <h3 className="font-title font-bold text-xl md:text-2xl text-white uppercase tracking-wider mb-6 flex items-center gap-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={index} className="flex items-center gap-3 bg-[#0a0a0a] p-4 rounded-xl border border-white/5">
            ...
            <div>
              <h3 className="font-title font-bold text-xl md:text-2xl text-[#bc151b] uppercase tracking-wider mb-6 flex items-center gap-3">
                <span className="w-2.5 h-6 bg-white rounded-full" />
                Bonus Khusus Member
              </h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-center justify-between bg-zinc-900/60 p-4 rounded-xl border border-[#bc151b]/20 hover:border-[#bc151b]/50 transition-all">
                    <div className="flex items-center gap-3">
                      <span className="text-lg">🎁</span>
                      <span className="text-white text-sm md:text-base font-bold uppercase tracking-wide">{item.title}</span>
                    </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-zinc-900/35 border border-white/5 p-6 rounded-2xl flex flex-col justify-between hover:border-[#bc151b]/35 transition-all">
                <div className="mb-6">
                ...
                <div className="flex items-center gap-3 border-t border-white/5 pt-4">
                  ...
                  <div>
                    <p className="text-white text-xs font-bold">Member PKA</p>
      ...
      {/* 11. Closing Section */}
      <section className="py-28 px-6 md:px-12 bg-zinc-950 border-t border-white/5 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto z-10 relative">
          <h2 className="text-3xl md:text-6xl font-title font-bold uppercase tracking-tight text-white mb-6 leading-tight">
          ...
          <div className="text-zinc-400 text-sm md:text-base leading-relaxed space-y-4 max-w-2xl mx-auto mb-10">
            <p>Kalau lo terus nunggu pede dulu… <span className="text-white font-semibold">mungkin lo gak akan pernah mulai.</span></p>
            <p>Tapi kalau lo mulai sekarang, siapa tau ini jadi awal perjalanan besar lo.</p>
            <p className="text-zinc-300 font-medium">Karena semua performer hebat… pernah punya panggung pertama.</p>
            <p className="text-[#bc151b] font-bold uppercase tracking-wide text-lg">Dan mungkin, hari ini adalah awal panggung lo.</p>
          </div>

          <Link href="/login" className="px-12 py-5 text-xl font-bold text-white uppercase tracking-wider bg-[#bc151b] rounded-xl hover:bg-[#bc151b]/90 transition-all transform hover:scale-105 shadow-[0_0_30px_rgba(188,21,27,0.6)]">
            DAFTAR SEKARANG
          </Link>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 bg-[#0a0a0a]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {faqData.map((faq, i) => (
              <div key={i} className="border border-white/10 rounded-xl bg-zinc-900/40 overflow-hidden transition-all">
                <button
                  onClick={() => toggleFaq(i)}
                  className="w-full px-6 py-5 text-left font-semibold text-sm md:text-base flex justify-between items-center hover:bg-[#bc151b]/5 transition-colors focus:outline-none"
                >
                  <span className="text-white font-title tracking-wide uppercase">{faq.q}</span>
                ...
                {activeFaq === i && (
                  <div className="px-6 py-5 text-zinc-300 text-sm leading-relaxed border-t border-white/5 bg-black/40">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <section className="py-20 px-6 md:px-12 bg-black border-t border-white/5 text-center relative">
        <div className="max-w-4xl mx-auto">
          <div className="w-12 h-12 bg-[#bc151b] rounded-xl flex items-center justify-center font-title font-bold text-white text-lg mx-auto mb-6 shadow-[0_0_15px_rgba(188,21,27,0.4)]">
            PKA
          </div>
          <h2 className="text-3xl md:text-5xl font-title font-bold uppercase text-white tracking-widest mb-4">
            Panggung Kreator Akademi
          </h2>
          <h3 className="text-lg md:text-xl font-medium text-[#bc151b] uppercase tracking-wide max-w-2xl mx-auto mb-12">
